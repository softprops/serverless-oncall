...
export = class Oncall {
    ...
    integrationPayload(serviceName: string, integration: IntegrationConfig): object {
        return {
            integration: {
                name: `${serviceName} ${integration.name} Integration`,
